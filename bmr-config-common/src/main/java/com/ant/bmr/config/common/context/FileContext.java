...
public class FileContext {
    ...
    public static final String PATH_NODE_GROUP_ID_PREFIX = "node-group-id-";
    public static final String XML_PROPERTY_TAG_NAME = "property";
    public static final String XML_NAME_TAG_NAME = "name";
    public static final String XML_VALUE_TAG_NAME = "value";
